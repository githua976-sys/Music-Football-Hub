...
const AboutPage = () => {
  return (
    <div className="space-y-12">
      ...
      {/* Footer Section */}
      <section className="bg-gray-900 rounded-3xl p-10 text-center">
        ...
        <p className="text-gray-400 mt-4 max-w-2xl mx-auto">
          ...
          This project combines two passions — music and football —
          into one modern dashboard experience powered by React and Tailwind CSS.
